...
- **Newsletter evergreen consolidada entre TODAS las verticales de COSMART** (pedido explícito de Vaneh: "TODOS... si entra como creadora, como marca, todos"). Ya no es solo gente que pide un lead magnet de Training — ver detalle completo en `cosmart-workers/HANDOFF.md`, sección "Newsletter evergreen".
...
7. **Rediseño de la tienda estilo Cutral-Có** (28/08): Vaneh pidió adaptar `tienda.html` a una estética con fondo azul/navy (en vez de arena/blanco) igual a la presentación PPT de Cutral-Có. El PDF **ya llegó** (reenviado en un mensaje posterior, 143 páginas, se leyeron las primeras 8) — lenguaje visual: navy/rojo/serif, motivo de brújula y camino, coherente con el branding que ya usa el sitio. **Todavía no arrancado.** Cuando se construya, Vaneh también quiere una opinión justificada de cuál versión convierte mejor (arena/blanco actual vs. navy nueva) — no improvisar la opinión, dar razones concretas de UX/conversión.
8. Las 4 imágenes sin nombre de módulo claro que subió Vaneh junto a las de Módulo 2-5 (`imagenes-iacursoemprendedores.png`, `...3.png`, `...13.png`, `...23.png`) no se agregaron a ningún módulo — preguntarle qué son antes de wirearlas a ciegas.
